#!/usr/bin/env Rscript
# WRF-STILT run script for IDN_BB_2015 — full October 2015 (Oct 6-31)
#
...
# ── Receptors ─────────────────────────────────────────────────────────────────
# Read from receptors_full_oct.csv: run_time, lati, long, zagl
receptors <- read.csv(file.path(stilt_wd, 'receptors_full_oct.csv'),
